...
(async () => {
  ...
  try {
    ...
    await page.screenshot({ path: path.join(OUTPUT_DIR, 'github-trending.png'), fullPage: false });
    ...
    await page.screenshot({ path: path.join(OUTPUT_DIR, 'github-trending-error.png'), fullPage: false });
  }
